...
Discover Similar Amazon Products using Machine Learning
</p>
""", unsafe_allow_html=True)
...
with col2:
    ...
    brand = selected_data["Brand Name"]
    ...
    st.markdown("### 📝 About Product")

    about = str(selected_data["About Product"])
    ...
    if pd.notna(selected_data["Product Url"]):
        st.link_button(
            "🛒 Buy on Amazon",
            selected_data["Product Url"]
        )
...
st.caption("© 2026 Amazon Product Recommendation System | Built with Python, Machine Learning & Streamlit")